...
function getUser_LostPassword(email, fn) {
	dynamodb.getItem({
...
function storeLostToken_LostPassword(email, fn) {
	// Bytesize
...
exports.handler = function(event, context) {
	...
	getUser_LostPassword(email, function(err, emailFound) {
		if (err) {
			...
			storeLostToken_LostPassword(email, function(err, token) {
				if (err) {
